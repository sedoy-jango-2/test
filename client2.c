...
void do_buying(Tickets* my_tickets, sem_t* main_semaphore, int client_num)
{
    ...
    int smokerplaces_tobuy = 12;
    int nonsmokerplaces_tobuy = 13;

    /* Actual places to buy */
    int smokerplaces[] = {3, 6, 4, 8, 11, 13, 15, 30, 16, 20, 21, 22};
    int nonsmokerplaces[] = {2, 4, 5, 7, 8, 9, 10, 11, 13, 15, 17, 18, 20};
