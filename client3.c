...
void do_buying(Tickets* my_tickets, sem_t* main_semaphore, int client_num)
{
    ...
    int smokerplaces_tobuy = 9;
    int nonsmokerplaces_tobuy = 20;

    /* Actual places to buy */
    int smokerplaces[] = {50, 49, 48, 47, 46, 45, 44, 43, 42};
    int nonsmokerplaces[] = {100, 99, 98, 97, 96, 95, 94, 93, 92, 91, 90, 89, 88, 87, 86, 85, 84, 83, 82, 81};
